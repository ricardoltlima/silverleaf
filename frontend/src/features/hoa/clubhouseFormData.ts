...
export const CLUBHOUSE_FORM_INTRO = `Community Homeowners Association, Inc.
Clubhouse Reservation Application and Agreement

I, the undersigned owner or legal tenant of Community Homeowners Association, do hereby make application and agree to rent and use the clubhouse during the requested reservation block.
...
- A rental fee of $250.00 and a separate security deposit of $250.00, of which both must be made payable to Community Homeowners Association, Inc. at the time of application.
...
- All reservations are subject to the approval of Community Homeowners Association HOA Board of Directors, or their assigned representative. The rental facility will only be rented to residents in good standing.
- The Community Homeowners Association reserves the right to cancel a reservation in the event that the clubhouse suffers damage or a system failure that cannot be repaired in time for the scheduled use. In the event of such a cancellation, the rental fee and security deposit will be returned in full.
...
6. The undersigned agrees to notify a member of the Board of Directors or the management company of any problems encountered and/or any damages to the clubhouse or grounds that occur during the scheduled event.`
  },
  {
    ...
    content: `The undersigned agrees to defend, indemnify and hold harmless Community Homeowners Association, its officers, directors, members, contractors, agents and employees from and against any suit, claim, loss or cause of action arising out of, or in conjunction with the utilization of the facilities, or the areas in proximity to the facilities, by undersigned pursuant to this agreement.

In addition, the undersigned agrees to reimburse Community HOA for any and all damages including, but not limited to equipment, fixtures, furniture or other property, either real or personal arising out of the utilization of the facilities, pursuant to this agreement, without regard to whether such damage is caused by the undersigned or is the result of negligence or other fault of the undersigned or the undersigned's guest.

Community Homeowners Association, Inc assumes no liability whatsoever to undersigned for any mechanical or electrical failure, natural disaster, riot, act of God or any other development which may prevent, disrupt, limit or frustrate the undersigned's use of the facilities and is not liable for the loss or damage to the undersigned's personal property.`
  },
  {
    id: "declaration",
    title: "Declaration",
    content: `I hereby declare that I am a Resident of Community Homeowners Association. I further declare that I enter into this agreement having read and fully understanding its terms and obligation; and that I and my guest(s) agree to abide by all rules, policies, procedures and regulations which govern The Community Homeowners Association clubhouse and recreational facilities.`
  },
  {
